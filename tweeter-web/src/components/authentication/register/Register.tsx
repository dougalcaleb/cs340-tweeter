...
const Register = () => {
	...
	const viewObserver: RegisterView = {
		setIsLoading,
		setImageUrl,
		setImageBytes,
	...
	if (!presenter.current) {
		presenter.current = new RegisterPresenter(viewObserver);
	}
	...
	const doRegister = () => presenter.current?.doRegister(firstName, lastName, alias, password, imageBytes, imageFileExtension, rememberMe);
