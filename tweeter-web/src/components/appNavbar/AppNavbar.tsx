...
const AppNavbar = () => {
	...
	const viewObserver: AppNavbarView = {
		displayInfoMessage,
		displayErrorMessage,
		deleteMessage,
		navigate,
	...
	if (!presenter.current) {
		presenter.current = new AppNavbarPresenter(viewObserver);
	}

	const logOut = () => presenter.current?.logOut(authToken!);
					...
					<Nav className="ml-auto">
						<Nav.Item>
							<NavLink
								...
								className={() => (location.pathname.startsWith("/feed/") ? "nav-link active" : "nav-link")}
							>
								Feed
							</NavLink>
						</Nav.Item>
						<Nav.Item>
							<NavLink
								...
								className={() => (location.pathname.startsWith("/story/") ? "nav-link active" : "nav-link")}
							>
								Story
							</NavLink>
						</Nav.Item>
						<Nav.Item>
							<NavLink
								...
								className={() => (location.pathname.startsWith("/followees/") ? "nav-link active" : "nav-link")}
							>
								Followees
							</NavLink>
						</Nav.Item>
						<Nav.Item>
							<NavLink
								...
								className={() => (location.pathname.startsWith("/followers/") ? "nav-link active" : "nav-link")}
							>
								Followers
							</NavLink>
						</Nav.Item>
